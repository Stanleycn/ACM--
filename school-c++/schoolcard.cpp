...
void Person::new_card(char *card_type)
{
	 ...
	 cin>>number;
	 riding_number=0;
	 if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/person.txt","r"))==NULL)
	 {
	    cout<<"无法打开文件"<<endl;
		exit(0);	
	 }
	 ...
	 if(flag==0)
	 { 
		 if((fp=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/person.txt","a+"))==NULL)
		 {
	        cout<<"无法打开文件"<<endl;
			exit(0);
		 }
	 ...
	 if(card_type=="E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/teacher.txt")
	 {
...
void Person::log_off(char *card_type)
{
	...
	if(times<=1)
	{
	    if((fp=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/person.txt","r"))==NULL)
	    {
           cout<<"无法打开文件"<<endl;
		   exit(0);
	    }
		...
		fclose(fp);
	    if((fp=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/person.txt","w"))==NULL)
	    {
           cout<<"无法打开文件"<<endl;
		   exit(0);
	    }
...
void Person::show_person_information(char *card_type)
{
	...
	while(!feof(fp))
	{
		...
		if(num==nu[k])
		{
		   ...
		   cout<<"性别："<<se[k]<<endl;
		   cout<<"身份："<<wo[k]<<endl;
		   cout<<"所属学院："<<un1[k]<<endl;
		   cout<<"工资号/学号："<<nu[k]<<endl; 
		   if(bal>=0) cout<<"余额："<<bal<<endl; 
		   cout<<"乘车次数："<<sum<<endl;
		   flag=1; 
		}
		k++;
...
void Bus::new_bus()
{
		...
		if((fp=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/bus.txt","a+"))==NULL)
	    {
            cout<<"无法打开文件"<<endl;
		    exit(0);
	    }
...
void Bus::show_basic_information()
{
     ...
     cout<<"输入要查询的车牌号:";
	 cin>>on;
	 if((fp=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/bus.txt","r"))==NULL)
	 {
         cout<<"无法打开文件"<<endl;
		 exit(0);
	 }
...
void Bus::show_run_information()
{
	...
	fclose(fp);
	k=0;
	if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/busactual.txt","r"))==NULL)
	{
		cout<<"无法打开文件"<<endl;
		exit(0);
	}
    ...
    fclose(fp1);
	if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/busactual.txt","w"))==NULL)
	{
		cout<<"无法打开文件"<<endl;
		exit(0);
	}
...
void Onecard::get_off(int get_off_place)
{
	...
	char s[100][100];long onc[100];char un[100][100];long va[100];int ba[100],ri[100],p[100];
    int i=0,k=0;
    if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/student.txt","r"))==NULL)
	{
        cout<<"无法打开文件"<<endl;
		exit(0);
	}
    ...
    fclose(fp1);
    if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/student.txt","w"))==NULL)
	{
        cout<<"无法打开文件"<<endl;
		exit(0);
	}
	...
	fclose(fp1);
    i=0;
    if((fp2=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/teacher.txt","r"))==NULL)
	{
        cout<<"无法打开文件"<<endl;
		exit(0);
	}
    ...
    fclose(fp2);
    if((fp2=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/teacher.txt","w"))==NULL)
	{
        cout<<"无法打开文件"<<endl;
		exit(0);
	}
	...
	fclose(fp2);
    i=0;
	if((fp3=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/limit.txt","r"))==NULL)
	{
        cout<<"无法打开文件"<<endl;
		exit(0);
	}
    ...
    fclose(fp3);
    if((fp3=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/limit.txt","w"))==NULL)
	{
        cout<<"无法打开文件"<<endl;
		exit(0);
	}
...
void Student::swiping_card()
{
	...
	if((fp2=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/busactual.txt","r"))==NULL)
	{
		cout<<"无法打开文件"<<endl;
		exit(0);
	}
	...
	fclose(fp);
	fclose(fp2);
	if((fp2=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/busactual.txt","w"))==NULL)
	{
		cout<<"无法打开文件"<<endl;
		exit(0);
	}
	...
	while(!feof(fp2))
	{
		...
		if(bus[k]==n)
		{
			...
			{  
			    cout<<"当前车上人数："<<ap[k]<<endl; 
			    ap[k]++;
		        if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/teacher.txt","r"))==NULL)
				{
			        cout<<"无法打开文件"<<endl;
					exit(0);
				}
				...
				if(flag)
				{ 
				    if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/teacher.txt","w"))==NULL)
				    {
			            cout<<"无法打开文件"<<endl;
					    exit(0);
				    }
	...
	while(!feof(fp2))
	{
		...
		if(bus[k]==n)
		{
	        ...
	        {   cout<<"当前车上人数："<<ap[k]<<endl; 
			    ...
			    if(flag)
			    {
				    if((fp1=fopen("E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/limit.txt","w"))==NULL)
			        {
		                cout<<"无法打开文件"<<endl;
				        exit(0);
			        }
...
void create_card()
{
	Person p;
	int flag;
	char *s="E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/student.txt",*t="E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/teacher.txt",*l="E:/QQPCmgr/Desktop/card-ride-system-master0/card-ride-system-master/limit.txt";
	menu2();
	cin>>flag;
